...
(function () {
    ...
    var RAW1 = [
        { id:1,  name:'Wireless Headphones',    description:'Premium ANC headphones with 30-hour battery and Hi-Res audio.',          price:149,  oldPrice:199, emoji:'🎧', badge:'hot',      rating:4.8, reviews:234, image:'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=max&w=800' },
        { id:2,  name:'Smart Fitness Band',     description:'Track steps, heart rate, sleep and GPS with 7-day battery life.',        price:79,   oldPrice:129, emoji:'⌚', badge:'trending', rating:4.5, reviews:156, image:'https://images.unsplash.com/photo-1575311373937-040b8e1fd5b6?auto=format&fit=max&w=800' },
        { id:3,  name:'Designer Backpack',      description:'Water-resistant 30L backpack with USB charging port and laptop sleeve.',  price:199,  oldPrice:299, emoji:'🎒', badge:'premium',  rating:4.7, reviews:189, image:'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?auto=format&fit=max&w=800' },
        { id:4,  name:'Gaming Laptop',          description:'RTX 4060, 16GB RAM, 1TB SSD — built for high-performance gaming.',       price:1299, oldPrice:1599, emoji:'💻', badge:'premium',  rating:4.9, reviews:312, image:'https://images.unsplash.com/photo-1496181133206-80ce9b88a853?auto=format&fit=max&w=800' },
        { id:5,  name:'Wireless Earbuds',       description:'True wireless with 28-hour total battery and IPX5 water resistance.',    price:89,   oldPrice:149, emoji:'🎵', badge:'trending', rating:4.6, reviews:267, image:'https://images.unsplash.com/photo-1590658268037-6bf12165a8df?auto=format&fit=max&w=800' },
        { id:6,  name:'Smart Watch Pro',        description:'ECG, SpO2, GPS and 5-day battery in a sleek titanium case.',             price:299,  oldPrice:399, emoji:'⌚', badge:'hot',      rating:4.8, reviews:445, image:'https://images.unsplash.com/photo-1523275335684-37898b6baf30?auto=format&fit=max&w=800' },
        { id:7,  name:'Premium Sneakers',       description:'Lightweight foam sole with breathable knit upper for all-day comfort.',  price:159,  oldPrice:229, emoji:'👟', badge:'trending', rating:4.4, reviews:198, image:'https://images.unsplash.com/photo-1542291026-7eec264c27ff?auto=format&fit=max&w=800' },
        { id:8,  name:'Portable Speaker',       description:'360° sound, IPX7 waterproof, 20-hour playtime, built-in powerbank.',     price:119,  oldPrice:179, emoji:'🔊', badge:'hot',      rating:4.7, reviews:223, image:'https://images.unsplash.com/photo-1545454675-3531b543be5d?auto=format&fit=max&w=800' },
        { id:9,  name:'4K Action Camera',       description:'4K/60fps, 20MP, HyperSmooth stabilisation and 170° wide lens.',          price:349,  emoji:'📷', badge:'new',      rating:4.8, reviews:98 },
        { id:10, name:'Mechanical Keyboard',    description:'RGB per-key lighting, hot-swap switches, aluminium frame.',              price:129,  emoji:'⌨️', badge:'trending', rating:4.6, reviews:142 },
        { id:11, name:'Gaming Mouse',           description:'25,600 DPI optical sensor, 11 programmable buttons, 70-hour battery.',   price:79,   emoji:'🖱️', badge:'hot',      rating:4.7, reviews:176 },
        { id:12, name:'Ultrawide Monitor',      description:'34" 3440×1440 IPS, 144Hz, 1ms, HDR400, USB-C 65W charging.',             price:699,  emoji:'🖥️', badge:'premium',  rating:4.9, reviews:87 },
        { id:13, name:'Noise-Cancel Earphones', description:'Hybrid ANC, 10mm drivers, 32-hour battery, multipoint pairing.',         price:199,  emoji:'🎶', badge:'new',      rating:4.5, reviews:64 },
        { id:14, name:'Smart Home Hub',         description:'Controls 100+ devices, works with Alexa, Google & HomeKit.',             price:99,   emoji:'🏠', badge:'trending', rating:4.3, reviews:118 },
        { id:15, name:'Drone Mini Pro',         description:'4K camera, 34-min flight, obstacle avoidance, foldable design.',         price:599,  emoji:'🚁', badge:'premium',  rating:4.8, reviews:93 }
    ];

var RAW2 = [
        { id:16, name:'Portable Charger 20K',   description:'20,000mAh, 65W PD, charges laptop + 2 phones simultaneously.',           price:59,   emoji:'🔋', badge:'hot',      rating:4.6, reviews:204 },
        { id:17, name:'Leather Wallet',         description:'Full-grain leather, RFID blocking, slim profile, 8 card slots.',         price:49,   emoji:'👜', badge:'new',      rating:4.4, reviews:76 },
        { id:18, name:'Sunglasses UV400',       description:'Polarised lenses, TR90 frame, 100% UV protection, unisex design.',       price:89,   emoji:'🕶️', badge:'trending', rating:4.5, reviews:132 },
        { id:19, name:'Coffee Maker Pro',       description:'15-bar espresso, built-in grinder, milk frother, 1.8L tank.',            price:249,  emoji:'☕', badge:'premium',  rating:4.7, reviews:85 },
        { id:20, name:'Yoga Mat Premium',       description:'6mm thick, non-slip surface, alignment lines, carry strap included.',    price:45,   emoji:'🧘', badge:'new',      rating:4.3, reviews:59 },
        { id:21, name:'Running Shoes X',        description:'Carbon fibre plate, responsive foam, breathable mesh upper.',            price:179,  emoji:'👟', badge:'hot',      rating:4.8, reviews:167 },
        { id:22, name:'Wireless Charger Pad',   description:'15W fast charge, Qi-certified, works with all Qi devices.',              price:35,   emoji:'⚡', badge:'trending', rating:4.4, reviews:188 },
        { id:23, name:'Smart LED Strip 5m',     description:'16M colours, music sync, app control, works with Alexa & Google.',       price:29,   emoji:'💡', badge:'new',      rating:4.2, reviews:71 },
        { id:24, name:'Stainless Steel Bottle', description:'500ml, triple-wall insulated, keeps cold 24h / hot 12h, BPA-free.',      price:39,   emoji:'🍶', badge:'trending', rating:4.6, reviews:149 },
        { id:25, name:'Tablet 10.5"',           description:'2K display, 8-core CPU, 8GB RAM, 256GB, 8000mAh, stylus support.',       price:449,  emoji:'📱', badge:'premium',  rating:4.7, reviews:104 }
    ];
